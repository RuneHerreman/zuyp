...
object FakeUsers {
    ...
    val userKoen = User(
        ...
        "https://i.pravatar.cc/150?u=koen.koreman@gmail.com"
    )
    val userLotte = User(
    ...
    val userMarkus = User(
        ...
        "https://i.pravatar.cc/150?u=markus.peeters@gmail.com"
    )
    val userCamille = User(
        UUID.fromString("20000000-0000-0000-0000-000000000025"),
        "Camille Ronsse",
        LocalDate.of(2005, 9, 2),
        "camille.ronsse@gmail.com",
        "https://i.pravatar.cc/150?u=camille.ronsse@gmail.com"
    )
    val userVictoria = User(
        UUID.fromString("20000000-0000-0000-0000-000000000026"),
        "Victoria Leemans",
        LocalDate.of(2003, 5, 25),
        "victoria.leemans@gmail.com",
        "https://i.pravatar.cc/150?u=victoria.leemans@gmail.com"
    )
    val userDieter = User(
        UUID.fromString("20000000-0000-0000-0000-000000000027"),
        "Dieter Wagemans",
        LocalDate.of(2002, 3, 16),
        "dieter.wagemans@gmail.com",
        "https://i.pravatar.cc/150?u=dieter.wagemans@gmail.com"
    )
    val userLea = User(
        UUID.fromString("20000000-0000-0000-0000-000000000028"),
        "Lea Snoeck",
        LocalDate.of(2004, 11, 7),
        "lea.snoeck@gmail.com",
        "https://i.pravatar.cc/150?u=lea.snoeck@gmail.com"
    )
    val userRyan = User(
        UUID.fromString("20000000-0000-0000-0000-000000000029"),
        "Ryan Debrouwer",
        LocalDate.of(2003, 6, 20),
        "ryan.debrouwer@gmail.com",
        "https://i.pravatar.cc/150?u=ryan.debrouwer@gmail.com"
    )
    val userSophie = User(
        ...
        "https://i.pravatar.cc/150?u=sophie.delvaux@gmail.com"
    )
    val userQuentin = User(
        UUID.fromString("20000000-0000-0000-0000-000000000031"),
        "Quentin Claes",
        LocalDate.of(2002, 9, 4),
        "quentin.claes@gmail.com",
        "https://i.pravatar.cc/150?u=quentin.claes@gmail.com"
    )
    val userEva = User(
        UUID.fromString("20000000-0000-0000-0000-000000000032"),
        "Eva Vanheule",
        LocalDate.of(2004, 10, 19),
        "eva.vanheule@gmail.com",
        "https://i.pravatar.cc/150?u=eva.vanheule@gmail.com"
    )
    val userLars = User(
        UUID.fromString("20000000-0000-0000-0000-000000000033"),
        "Lars Bosmans",
        LocalDate.of(2003, 2, 8),
        "lars.bosmans@gmail.com",
        "https://i.pravatar.cc/150?u=lars.bosmans@gmail.com"
    )
    val userAnna = User(
        UUID.fromString("20000000-0000-0000-0000-000000000034"),
        "Anna Vanzeir",
        LocalDate.of(2004, 7, 31),
        "anna.vanzeir@gmail.com",
        "https://i.pravatar.cc/150?u=anna.vanzeir@gmail.com"
    )
    val userTom = User(
        UUID.fromString("20000000-0000-0000-0000-000000000035"),
        "Tom Baert",
        LocalDate.of(2002, 4, 22),
        "tom.baert@gmail.com",
        "https://i.pravatar.cc/150?u=tom.baert@gmail.com"
    )
    val userEmilie = User(
        UUID.fromString("20000000-0000-0000-0000-000000000036"),
        "Emilie Briers",
        LocalDate.of(2005, 8, 6),
        "emilie.briers@gmail.com",
        "https://i.pravatar.cc/150?u=emilie.briers@gmail.com"
    )
    val userPhilip = User(
        UUID.fromString("20000000-0000-0000-0000-000000000037"),
        "Philip Everard",
        LocalDate.of(2002, 6, 13),
        "philip.everard@gmail.com",
        "https://i.pravatar.cc/150?u=philip.everard@gmail.com"
    )
    val userClaire = User(
        UUID.fromString("20000000-0000-0000-0000-000000000038"),
        "Claire Genon",
        LocalDate.of(2004, 9, 29),
        "claire.genon@gmail.com",
        "https://i.pravatar.cc/150?u=claire.genon@gmail.com"
    )
    val userSven = User(
        UUID.fromString("20000000-0000-0000-0000-000000000039"),
        "Sven Guelinckx",
        LocalDate.of(2001, 12, 11),
        "sven.guelinckx@gmail.com",
        "https://i.pravatar.cc/150?u=sven.guelinckx@gmail.com"
    )
    val userBeat = User(
        ...
        "https://i.pravatar.cc/150?u=beat.greyling@gmail.com"
    )
    val userLena = User(
        ...
        "https://i.pravatar.cc/150?u=lena.goyvaerts@gmail.com"
    )
    val userJulian = User(
        ...
        "https://i.pravatar.cc/150?u=julian.groote@gmail.com"
    )
    val userSienna = User(
        ...
        "https://i.pravatar.cc/150?u=sienna.gregoor@gmail.com"
    )
    val userAlex = User(
        UUID.fromString("20000000-0000-0000-0000-000000000044"),
        "Alex Grill",
        LocalDate.of(2002, 10, 9),
        "alex.grill@gmail.com",
        "https://i.pravatar.cc/150?u=alex.grill@gmail.com"
    )
    val userOliver = User(
        UUID.fromString("20000000-0000-0000-0000-000000000045"),
        "Oliver Hanssens",
        LocalDate.of(2005, 2, 14),
        "oliver.hanssens@gmail.com",
        "https://i.pravatar.cc/150?u=oliver.hanssens@gmail.com"
    )
    val userMaya = User(
        UUID.fromString("20000000-0000-0000-0000-000000000046"),
        "Maya Vandenbroeck",
        LocalDate.of(2003, 12, 3),
        "maya.vandenbroeck@gmail.com",
        "https://i.pravatar.cc/150?u=maya.vandenbroeck@gmail.com"
    )
    val userLuc = User(
        UUID.fromString("20000000-0000-0000-0000-000000000047"),
        "Luc Vanhove",
        LocalDate.of(2002, 1, 21),
        "luc.vanhove@gmail.com",
        "https://i.pravatar.cc/150?u=luc.vanhove@gmail.com"
    )
    val userAnne = User(
        UUID.fromString("20000000-0000-0000-0000-000000000048"),
        "Anne Verheggen",
        LocalDate.of(2004, 5, 10),
        "anne.verheggen@gmail.com",
        "https://i.pravatar.cc/150?u=anne.verheggen@gmail.com"
    )
    val userDavid = User(
        UUID.fromString("20000000-0000-0000-0000-000000000049"),
        "David Verhoeven",
        LocalDate.of(2003, 9, 7),
        "david.verhoeven@gmail.com",
        "https://i.pravatar.cc/150?u=david.verhoeven@gmail.com"
    )
    val userFlorence = User(
        UUID.fromString("20000000-0000-0000-0000-000000000050"),
        "Florence Veron",
        LocalDate.of(2005, 7, 23),
        "florence.veron@gmail.com",
        "https://i.pravatar.cc/150?u=florence.veron@gmail.com"
    )
    val userNico = User(
        ...
        "https://i.pravatar.cc/150?u=nico.verpieren@gmail.com"
    )
    val userGrace = User(
        UUID.fromString("20000000-0000-0000-0000-000000000052"),
        "Grace Veuger",
        LocalDate.of(2004, 10, 15),
        "grace.veuger@gmail.com",
        "https://i.pravatar.cc/150?u=grace.veuger@gmail.com"
    )
    val userChris = User(
        UUID.fromString("20000000-0000-0000-0000-000000000053"),
        "Chris Vierde",
        LocalDate.of(2003, 4, 28),
        "chris.vierde@gmail.com",
        "https://i.pravatar.cc/150?u=chris.vierde@gmail.com"
    )
    val userMaria = User(
        UUID.fromString("20000000-0000-0000-0000-000000000054"),
        "Maria Villard",
        LocalDate.of(2005, 6, 12),
        "maria.villard@gmail.com",
        "https://i.pravatar.cc/150?u=maria.villard@gmail.com"
    )
    val userSteve = User(
        ...
        "https://i.pravatar.cc/150?u=steve.vivier@gmail.com"
    )
    val userJessica = User(
        UUID.fromString("20000000-0000-0000-0000-000000000056"),
        "Jessica Voegele",
        LocalDate.of(2004, 1, 6),
        "jessica.voegele@gmail.com",
        "https://i.pravatar.cc/150?u=jessica.voegele@gmail.com"
    )
    val userPaul = User(
        UUID.fromString("20000000-0000-0000-0000-000000000057"),
        "Paul Vogel",
        LocalDate.of(2003, 3, 17),
        "paul.vogel@gmail.com",
        "https://i.pravatar.cc/150?u=paul.vogel@gmail.com"
    )
    val userRosa = User(
        UUID.fromString("20000000-0000-0000-0000-000000000058"),
        "Rosa Voigt",
        LocalDate.of(2005, 11, 24),
        "rosa.voigt@gmail.com",
        "https://i.pravatar.cc/150?u=rosa.voigt@gmail.com"
    )
